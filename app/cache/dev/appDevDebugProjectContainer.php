...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'relaxstyle', 'user' => 'root', 'password' => 123456, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array('enum' => 'string', 'set' => 'string', 'varbinary' => 'string', 'tinyblob' => 'text'));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Relaxstyle/IndexBundle/Entity'))), 'Relaxstyle\\IndexBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('RelaxstyleIndexBundle' => 'Relaxstyle\\IndexBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4c203f43e4fcc4b5e224ac5510e370967204360f53eaa1e113aeb1ed8237dc22');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('dirk.wang@samesamechina.com');
        $a->setPassword('same2015');
        $a->setAuthMode(NULL);

        $this->services['swiftmailer.mailer.default.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));

        $instance->setHost('smtp.exmail.qq.com');
        $instance->setPort(25);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Relaxstyle/IndexBundle/Resources/views'), 'RelaxstyleIndex');
        $instance->addPath(($this->targetDirs[3].'/src/Relaxstyle/BlogBundle/Resources/views'), 'RelaxstyleBlog');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'RelaxstyleIndexBundle' => 'Relaxstyle\\IndexBundle\\RelaxstyleIndexBundle',
                'RelaxstyleBlogBundle' => 'Relaxstyle\\BlogBundle\\RelaxstyleBlogBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'relaxstyle',
            'database_user' => 'root',
            'database_password' => 123456,
            'mailer_transport' => 'smtp',
            'mailer_host' => 'smtp.exmail.qq.com',
            'mailer_user' => 'dirk.wang@samesamechina.com',
            'mailer_password' => 'same2015',
            'locale' => 'en',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'smtp.exmail.qq.com',
            'swiftmailer.mailer.default.transport.smtp.username' => 'dirk.wang@samesamechina.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'same2015',
